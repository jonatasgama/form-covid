...
<div class="card mt-3">
	<div class="card-header">
		<h4>Procurar Registro</h4>
	</div>
	<div class="card-body">

		<form class="row" action="<?=base_url('administracao/procuraMatricula');?>" method="post">
		...
		<form class="row" action="<?=base_url('administracao/procuraPorUsuario');?>" method="post">
			<div class="col-sm-4 offset-2">
				<select name="usuario" id="usuario" class="form-select form-select mb-3">
