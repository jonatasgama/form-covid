                    ...
                    <p class="lead">Total cadastrados: <?=$total;?></p>
                    <!-- Content Row -->
                    <div class="row">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Pacientes com Covid</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$covid[0]->total;?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Obesos</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$obesos[0]->total;?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Desfecho óbito</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$obito[0]->total;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <!--<i class="fas fa-comments fa-2x text-gray-300"></i>-->
                                        </div>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Covid sem evento tromboembólico</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$covidSemEventoTromb[0]->total;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <!--<i class="fas fa-dollar-sign fa-2x text-gray-300"></i>-->
                                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Covid por mês</h6>
                                </div>
                                <!--Card Body-->
                                <div class="card-body">
