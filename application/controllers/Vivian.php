...
class Vivian extends CI_Controller {
	...
	function save() {		
		...
		$this->form_validation->set_rules('maior_70', 'Maior_70', 'required');
		...
		$this->form_validation->set_rules('icc_ou_ir', 'Icc_ou_ir', 'required');
		...
		$this->form_validation->set_rules('neoplasia_maligna', 'Neoplasia_maligna', 'required');
		$this->form_validation->set_rules('cancer_ativo', 'Cancer_ativo', 'required');
		...
		$this->form_validation->set_rules('ag_estimulante_eritropoese', 'Ag_estimulante_eritropoese', 'required');
		...
		$this->form_validation->set_rules('score_de_padua', 'Score_de_padua', 'required');
